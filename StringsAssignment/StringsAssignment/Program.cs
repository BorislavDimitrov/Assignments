...
Console.WriteLine($"The total count of the words is {wordsCount}");
...
Console.WriteLine($"The total count of the sentences is {sentenceCounter}");

Console.WriteLine(new string('-', 100));

int count = 0;
int index = text.IndexOf("encapsulation", StringComparison.OrdinalIgnoreCase);

while (index != -1)
{
    count++;
    index = text.IndexOf("encapsulation", index + 1, StringComparison.OrdinalIgnoreCase);
}

Console.WriteLine($"The word encapsulation occurs {count} times");
